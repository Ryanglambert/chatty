...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() returns False for quetsions whose pub_date is in the future
        """
...
class QuestionIndexView(TestCase):
    ...
    def test_no_future_question_access_directly(self):
        """
        User should not be able to get to the future question directly
        """
